...
class CdpSession extends EventEmitter {
  ...
  async evaluate(expression, extra = {}) {
    ...
    const timeoutMs = extra.timeoutMs != null ? Math.max(1, Number(extra.timeoutMs) || this.timeoutMs) : this.timeoutMs;
    const result = await this.send("Runtime.evaluate", params, timeoutMs);
